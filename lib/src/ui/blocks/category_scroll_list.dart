...
class CategoryScrollList extends StatefulWidget {
  ...
  const CategoryScrollList({super.key, required this.block, required this.categories, required this.onCategoryClick});
  @override
...
class CategoryScrollStadiumList extends StatefulWidget {
  ...
  final List<Category> categories;
  final Function onCategoryClick;
  const CategoryScrollStadiumList({super.key, required this.block, required this.categories, required this.onCategoryClick});
  @override
