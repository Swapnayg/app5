...
class CategoryGridList extends StatefulWidget {
  ...
  const CategoryGridList({super.key, required this.block, required this.categories, required this.onCategoryClick});
  @override
...
class CategoryStadiumGridList extends StatefulWidget {
  ...
  final List<Category> categories;
  final Function onCategoryClick;
  const CategoryStadiumGridList({super.key, required this.block, required this.categories, required this.onCategoryClick});
  @override
