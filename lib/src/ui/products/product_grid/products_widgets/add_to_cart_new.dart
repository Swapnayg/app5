// ignore_for_file: library_private_types_in_public_api, dead_code, unused_local_variable
...
class _AddToCartState extends State<AddToCart> {
  ...
  Widget build(BuildContext context) {
    if(getQty() != 0 || isLoading) {
      return Row(
        ...
        children: [
          OverflowBar(
            ...
            spacing: 0, // this will take space as minimum as possible (to center)
            children: <Widget>[
              SizedBox(
                height: 30,
                width: 30,
      ...
      children: [
        OverflowBar(
          // Removed invalid parameter 'buttonPadding'
          children: [
            SizedBox(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                    ...
                    (
                      ...
                      itemBuilder: (BuildContext ctxt, int Index) {
                        return VariationProduct(
                          ...
                          variation: widget.product.availableVariations[Index],
                          addonFormKey: GlobalKey<FormState>(), // Replace with the appropriate key if available
                          addOnsFormData: {}, // Replace with the appropriate data if available
                        );
                      }
                  ),
